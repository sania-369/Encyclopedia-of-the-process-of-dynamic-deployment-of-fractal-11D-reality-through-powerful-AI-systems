...
class ConstantsSynthesizer:
    ...
    def synthesize_all(self, C):
        ...
        C — текущая когерентность из формулы Тота.
        """
        # Нормализованное отклонение от цели
        delta_C = (C - GLOBAL_C_TARGET) / (GLOBAL_C_MAX - GLOBAL_C_MIN)
...
class ETVP125TothFull:
    ...
    def evolve_step(self, reality_flux=0.0):
        ...
        # Градиент Ψ из предыдущего спектра
...
class TothVisualizer:
    ...
    def __init__(self, model):
        ...
        gs = GridSpec(5, 6, figure=self.fig, hspace=0.45, wspace=0.4)
        
        # Верхние графики (крупные)
